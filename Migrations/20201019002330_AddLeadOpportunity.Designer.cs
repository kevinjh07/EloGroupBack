...
namespace EloGroupBack.Migrations
{
    ...
    [Migration("20201019002330_AddLeadOpportunity")]
    partial class AddLeadOpportunity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EloGroupBack.Models.LeadOpportunity", b =>
                {
                    b.Property<int>("LeadId");

                    b.Property<int>("OpportunityId");

                    b.HasKey("LeadId", "OpportunityId");
            ...
            modelBuilder.Entity("EloGroupBack.Models.LeadOpportunity", b =>
                {
                    b.HasOne("EloGroupBack.Models.Lead", "Lead")
                        .WithMany("LeadOpportunities")
                        .HasForeignKey("LeadId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("EloGroupBack.Models.Opportunity", "Opportunity")
                        .WithMany("LeadOpportunities")
